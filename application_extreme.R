...
ggplot(data=df, aes(x=lambda)) +
  geom_line(aes(y=lasso_edges/5,color="Graphical lasso"),linewidth=0.8)+
  geom_line(aes(y=mixed_edges/5,color="Graphical lasso with positivity"),linewidth=0.8)+
  geom_line(aes(y=positivity_edges/5,color="Positivity"),linewidth=0.8)+
